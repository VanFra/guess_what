...
st.sidebar.markdown("Use the menu to switch between pages.")
page = st.sidebar.selectbox("Choose a page", ["Game", "Stats", "Countries"])
...
# region Initializing of variables
    ...
    if st.session_state.game_running == True:
        ...
        # check whether the user wants a hint
            ...
            # if no country is mentioned
                ...
                with st.chat_message("assistant"):
                    st.markdown("Please enter a valid country name.")
